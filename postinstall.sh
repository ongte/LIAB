...
echo "if [ -f ~/.config_registry ]; then echo; echo; echo Please run the script \'registry.sh\' now to configure the container registry.; echo; rm -f ~/.config_registry; fi" >> /root/.bashrc
